...
function isClick(start, end, options) {
  ...
  var fineInterval = (options.fineInterval != null) ? options.fineInterval : FINE_INTERVAL;

  start.point = start.point || end.point;
  start.time = start.time || end.time;
  var moveDistance = euclideanDistance(start.point, end.point);

  return (moveDistance < fineTolerance && (end.time - start.time) < fineInterval) ||
